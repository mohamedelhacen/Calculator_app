...
def calculator():
    ...
    num_button = partial(tk.Button, root, fg=text_fg, bg=num_button_bg,
                         padx=10, pady=3, activebackground=button_active_bg)
    cal_button = partial(tk.Button, root, fg=text_fg, bg=cal_button_bg,
                         padx=10, pady=3, activebackground=button_active_bg)
    ...
    button10.grid(row=5, column=1, pady=5)
    ...
    button13.grid(row=4, column=3, pady=5)
